...
docker run --rm -v $root_dir:/tmp aldanial/cloc ./ --unix --by-file --csv --quiet --vcs=git --exclude-dir=docs,.vscode,.github --not-match-f=package-lock\.json --report-file=./docs/code-maat/data/complexity.csv
